...
2. **Presents a USB personality** to the host PC/console. The same controller input can be re-dressed as the
   Valve puck (for Steam), an Xbox 360/Xbox One pad, a Switch controller, a PS5 DualSense, or a DS4 — selected at boot.
...
| `mode_xinput.{h,cpp}` | **Xbox (360/One)** personality: a custom TinyUSB XInput class driver + right-pad mouse + rumble relay. |
